...
// DefaultPrettyOptions is the default options for pretty formats.
var DefaultPrettyOptions = &PrettyOptions{Width: 80, Prefix: "", Indent: "  ", SortKeys: false}
...
func Pretty(json []byte) []byte { return NewPrettyOptions(json, nil) }

// PrettyOptions is like Pretty but with customized options.
func NewPrettyOptions(json []byte, opts *PrettyOptions) []byte {
    if opts == nil {
